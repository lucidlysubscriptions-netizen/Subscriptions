import svgPaths from "./svg-b9zxawf7nz";
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[12px] items-center left-1/2 text-black text-center top-[222px] w-[446px]">
      <p className="font-['Hanken_Grotesk:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[24px] w-full">Sent to @telegramID on Telegram</p>
      <p className="font-['Hanken_Grotesk:Regular',sans-serif] font-normal leading-[22px] opacity-70 relative shrink-0 text-[16px] w-full">You will receive Claude Pro Subscription link within 24 hrs.</p>
    </div>
  );
}
